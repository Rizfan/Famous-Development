...
<body>
  ...
  <!-- Navbar -->
  <section id="nav">
    <nav class="navbar bg-white navbar-expand-md navbar-light shadow-sm fixed-top">
      <div class="container">
        ...
        <!-- <li class="nav-item">
         ...
         @if (Route::has('register'))
                      ...
                      <section class="footer" style="background-color: #ddd;">
                        <div class="container">
                          <div class="row">
                            <div class="col col-12 col-md-3 text-center">
                              <div class="logo-footer mt-5">

                                <img src="{{'/img/2.png'}}" alt="" class="img-fluid aaa" width="80%">
                              </div>
                            </div>
                            <div class="col col-12 col-md-3 mt-5 footer-sect">
                              <div class="kontak-footer">
                                      ...
                                      <div class="col col-12 col-md-3 mt-5 footer-sect">
                                        <div class="kontak-footer">
                                          ...
                                          <div class="footer-grids">
                                            <ul>
                                              <li class="">
                                                <a href="#"  class="sat alink-team"><i class="fa fa-arrow-up"></i></a></p>
                                ...
                                <script src="{{asset('ck_editor/ckeditor.js')}}"></script>
